...
var autotuneEnabled = false; // we set autotune to false by default
...
function removeReverb(){
    if (reverb) {
        ...
        console.log('Reverb is now removed');
    }
}
...
function runAfterLoadingPage() {
    ...
    chromatic.addEventListener("change", () => {
        autotuneEnabled = chromatic.value === "true";
    });
